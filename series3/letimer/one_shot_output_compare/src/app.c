...
void letimer_init(void)
{
  ...
  init.underflow_output0_action = SL_HAL_LETIMER_UNDERFLOW_OUTPUT_ACTION_TOGGLE;
  init.repeat_mode = SL_HAL_LETIMER_REPEAT_MODE_ONESHOT;
  ...
  // repeat 10 times
  sl_hal_letimer_set_repeat(LETIMER0,0,REPEAT_COUNT);
