# Peripheral Examples - PCNT Oversampling Quadrature #
...
6. Repeat steps 3-5 for a total of 11 presses and releases 
7. Observe LED1 toggles on to indicate an overflow; with hysteresis, count is 
   reloaded with TOP/2 = 5 for this example
8. Repeat steps 3-5 for a total of 6 presses and releases
