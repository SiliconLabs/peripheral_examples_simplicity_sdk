...
4. Pause the debugger, add the buffer[] variable to the Expressions pane, and expand the array to see each the value of the counter for each edge (button press) captured.
