# Peripheral Examples - I2C Leader Interrupt #

## Summary ##

This project demonstrates interrupt-driven I2C leader operation of an SiMG301 device. As with the I2C Leader with LDMA example, two devices are connected, with one running this leader example project and the other running the follower project. The leader starts up and sits in a while loop waiting for a press on push button 0.
