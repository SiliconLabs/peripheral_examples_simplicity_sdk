...
* ADC
    ...
    * Comparison window set to trigger when input voltage is between 0.605V and 1.815V
...
6. Adjust the analog input voltage between the defined window (between 0.605V and 1.815V)
