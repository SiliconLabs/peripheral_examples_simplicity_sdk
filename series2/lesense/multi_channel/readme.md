# Peripheral Examples - LESENSE Multi Channel #
...
>      implemented a escape_hatch, where if the user holds down push button 0 when
...
* CMU
  ...
  * EM23GRACLK - 1 MHz
* IADC
  * 12-bit resolution, Unipolar (single-ended), unbuffered 3.3V (AVDD) 
...
* GPIO
* LESENSE
  * 32 Hz scan rate; LESENSE scans all enabled channels per scan cycle:
             32 samples per second per channel

## How to test: ##

1.  Build the project and download it to the starter kit
2.  Run the code, connect LESENSE channel 2 pin to 3.3V
