...
#define I2C_LEADER_SCL_PIN   0
#define I2C_LEADER_SDA_PORT  gpioPortC
#define I2C_LEADER_SDA_PIN   1
...
#define GPIO_IADC0_EOC_PORT      gpioPortC
#define GPIO_IADC0_EOC_PIN       3

// GPIO output to indicate LDMA transfer complete
#define GPIO_LDMA_COMPLETE_PORT   gpioPortC
#define GPIO_LDMA_COMPLETE_PIN    3
