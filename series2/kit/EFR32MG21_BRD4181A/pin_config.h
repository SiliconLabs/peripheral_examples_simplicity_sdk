...
#define I2C_LEADER_SCL_PORT         EXP_SPI_COPI_PORT
#define I2C_LEADER_SCL_PIN          EXP_SPI_COPI_PIN

#define I2C_LEADER_SDA_PORT         EXP_SPI_CIPO_PORT
#define I2C_LEADER_SDA_PIN          EXP_SPI_CIPO_PIN
...
#define GPIO_IADC0_EOC_PORT         EXP_SPI_CS_PORT
#define GPIO_IADC0_EOC_PIN          EXP_SPI_CS_PIN

#define GPIO_LDMA_COMPLETE_PORT     EXP_SPI_CS_PORT
#define GPIO_LDMA_COMPLETE_PIN      EXP_SPI_CS_PIN
...
#define SPI_TIME_PORT               BUTTON0_PORT
#define SPI_TIME_PIN                BUTTON0_PIN
