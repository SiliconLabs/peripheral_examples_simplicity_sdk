...
void i2c_init(void)
{
  ...
  GPIO->I2CROUTE[0].SCLROUTE = (I2C_LEADER_SCL_PORT << _GPIO_I2C_SCLROUTE_PORT_SHIFT
                             | (I2C_LEADER_SCL_PIN << _GPIO_I2C_SCLROUTE_PIN_SHIFT));
  GPIO->I2CROUTE[0].SDAROUTE = (I2C_LEADER_SDA_PORT << _GPIO_I2C_SDAROUTE_PORT_SHIFT
...
void I2C_LeaderWrite()
{
  ...
  DMADRV_LdmaStartTransfer(txChannelId, &i2c_txReq, &i2c_txDesc[0], NULL, NULL);
