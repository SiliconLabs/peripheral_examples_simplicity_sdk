# Peripheral Examples - EUSART Asynchronous Interrupt #

## Summary ##

This project demonstrates interrupt-driven operation of the EUSART in
asynchronous mode.  EUSART0 is configured for asynchronous operation at
