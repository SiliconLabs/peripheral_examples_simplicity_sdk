/***************************************************************************//**
 * @file main_scan_interrupt_dvl_4_xG27.c
...
void initIADC (void)
{
  ...
  initScanTable.entries[4].posInput = iadcPosInputVbat;      // Add VBAT to scan for demonstration purposes
  ...
  initScanTable.entries[5].posInput = iadcPosInputVss;       // Add VSS to scan for demonstration purposes
