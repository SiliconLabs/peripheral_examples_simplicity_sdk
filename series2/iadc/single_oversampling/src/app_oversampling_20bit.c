...
const sl_gpio_t GPIO_OUTPUT0 = { .port = GPIO_OUTPUT_0_PORT, .pin = GPIO_OUTPUT_0_PIN };
...
void IADC_IRQHandler(void)
{
  ...
  // For single-ended the result range is 0 to +Vref, i.e., 20 bits for the conversion value.
  singleResult = (double)sample.data * 2.42 / 0xFFFFF;
