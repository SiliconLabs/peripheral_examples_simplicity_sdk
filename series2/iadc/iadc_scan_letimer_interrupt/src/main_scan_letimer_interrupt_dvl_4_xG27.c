/***************************************************************************//**
 * @file main_scan_letimer_interrupt_dvl_4_xG27.c
 *
...
void initIADC(void)
{
  ...
  scanTable.entries[4].posInput = iadcPosInputVbat;       // Add VBAT to scan for demonstration purposes
  ...
  scanTable.entries[5].posInput = iadcPosInputVss;       // Add VSS to scan for demonstration purposes
