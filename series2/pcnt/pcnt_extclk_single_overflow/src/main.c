 ...
 * program generates an interrupt whenever the pulse counter goes above the
 * configured top value. Each press of Push Button PB0 will increase the
 * counter value by 1. The initial value of the counter is zero (default) and
 * top register is set by PCNTTopValue define.
 *******************************************************************************
 * # License
