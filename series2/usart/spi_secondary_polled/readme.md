# Peripheral Examples - SPI secondary polled #
...
4. After starting the example, set a breakpoint at the 
   sl_hal_gpio_clear_interrupts() statement in app_process_action(). The 
   buffer[] array should contain the values sent by the main (0 to 9 inclusive).
   The main example transfers data continuously but will not start until PB0 is 
   pressed.
