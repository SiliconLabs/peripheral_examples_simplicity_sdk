# Peripheral Examples - SPI main with DMA #
...
4. Before running the example, set a breakpoint on the appState = RECEIVE
   statement in app_process_action().  Examine the inbuf[] array to see the
