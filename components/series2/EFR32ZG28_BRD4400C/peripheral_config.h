...
// LESENSE IADC inputs
#define LESENSE_IADC_INPUT_0_PORT_PIN      iadcPosInputPortBPin1
#define LESENSE_IADC_INPUT_1_PORT_PIN      iadcPosInputPortBPin3
#define LESENSE_IADC_INPUT_2_PORT_PIN      iadcPosInputPortBPin4
#define LESENSE_IADC_INPUT_3_PORT_PIN      iadcPosInputPortBPin5

#define LESENSE_IADC_INPUT_0_BUS           BBUSALLOC
#define LESENSE_IADC_INPUT_0_BUSALLOC      GPIO_BBUSALLOC_BODD0_ADC0

#define LESENSE_IADC_INPUT_1_BUS           BBUSALLOC
#define LESENSE_IADC_INPUT_1_BUSALLOC      GPIO_BBUSALLOC_BODD0_ADC0

#define LESENSE_IADC_INPUT_2_BUS           BBUSALLOC
#define LESENSE_IADC_INPUT_2_BUSALLOC      GPIO_BBUSALLOC_BEVEN0_ADC0

#define LESENSE_IADC_INPUT_3_BUS           BBUSALLOC
#define LESENSE_IADC_INPUT_3_BUSALLOC      GPIO_BBUSALLOC_BODD0_ADC0
